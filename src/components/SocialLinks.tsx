...
export default function SocialLinks() {
  ...
  const socialLinks = [
    ...
    {
      name: 'Spotify',
      username: 'Codalot Podcast',
      url: 'https://open.spotify.com/show/1iyrRtXu0hrOQJyA7vdGiX',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
